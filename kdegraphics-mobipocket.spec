...
Source0  : https://download.kde.org/stable/applications/18.08.0/src/kdegraphics-mobipocket-18.08.0.tar.xz
Source99 : https://download.kde.org/stable/applications/18.08.0/src/kdegraphics-mobipocket-18.08.0.tar.xz.sig
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0
Requires: kdegraphics-mobipocket-lib
Requires: kdegraphics-mobipocket-license
Requires: kdegraphics-mobipocket-data
...
Requires: kdegraphics-mobipocket-lib
Requires: kdegraphics-mobipocket-data
Provides: kdegraphics-mobipocket-devel
...
%prep
%setup -q -n kdegraphics-mobipocket-18.08.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1535196160
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
export SOURCE_DATE_EPOCH=1535196160
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/kdegraphics-mobipocket
cp COPYING %{buildroot}/usr/share/doc/kdegraphics-mobipocket/COPYING
pushd clr-build
%make_install
popd
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/kdegraphics-mobipocket/COPYING
