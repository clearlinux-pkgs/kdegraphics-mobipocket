...
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/kdegraphics-mobipocket-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/kdegraphics-mobipocket-24.12.0.tar.xz.sig
...
%setup -q -n kdegraphics-mobipocket-24.12.0
cd %{_builddir}/kdegraphics-mobipocket-24.12.0
pushd ..
cp -a kdegraphics-mobipocket-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735240462
mkdir -p clr-build
pushd clr-build
