...
Version  : 25.04.0
Release  : 81
URL      : https://download.kde.org/stable/release-service/25.04.0/src/kdegraphics-mobipocket-25.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/kdegraphics-mobipocket-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/kdegraphics-mobipocket-25.04.0.tar.xz.sig
...
%setup -q -n kdegraphics-mobipocket-25.04.0
cd %{_builddir}/kdegraphics-mobipocket-25.04.0
pushd ..
cp -a kdegraphics-mobipocket-25.04.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744938634
mkdir -p clr-build
pushd clr-build
