...
Source0  : https://download.kde.org/stable/release-service/19.12.0/src/kdegraphics-mobipocket-19.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.0/src/kdegraphics-mobipocket-19.12.0.tar.xz.sig
...
%prep
%setup -q -n kdegraphics-mobipocket-19.12.0
cd %{_builddir}/kdegraphics-mobipocket-19.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576532000
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdegraphics-mobipocket-19.12.0/COPYING %{buildroot}/usr/share/package-licenses/kdegraphics-mobipocket/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
pushd clr-build
%make_install
popd
