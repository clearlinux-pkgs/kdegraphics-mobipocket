...
Version  : 24.02.0
Release  : 64
URL      : https://download.kde.org/stable/release-service/24.02.0/src/kdegraphics-mobipocket-24.02.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/kdegraphics-mobipocket-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/kdegraphics-mobipocket-24.02.0.tar.xz.sig
...
%prep
%setup -q -n kdegraphics-mobipocket-24.02.0
cd %{_builddir}/kdegraphics-mobipocket-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709337908
mkdir -p clr-build
pushd clr-build
