...
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/kdegraphics-mobipocket-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/kdegraphics-mobipocket-23.08.5.tar.xz.sig
...
%prep
%setup -q -n kdegraphics-mobipocket-23.08.5
cd %{_builddir}/kdegraphics-mobipocket-23.08.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708413554
mkdir -p clr-build
pushd clr-build
