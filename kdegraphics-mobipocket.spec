...
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/kdegraphics-mobipocket-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/kdegraphics-mobipocket-24.12.1.tar.xz.sig
...
%setup -q -n kdegraphics-mobipocket-24.12.1
cd %{_builddir}/kdegraphics-mobipocket-24.12.1
pushd ..
cp -a kdegraphics-mobipocket-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736552425
mkdir -p clr-build
pushd clr-build
