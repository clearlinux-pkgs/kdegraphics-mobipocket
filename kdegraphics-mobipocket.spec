...
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/kdegraphics-mobipocket-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/kdegraphics-mobipocket-24.05.0.tar.xz.sig
...
%setup -q -n kdegraphics-mobipocket-24.05.0
cd %{_builddir}/kdegraphics-mobipocket-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716574478
mkdir -p clr-build
pushd clr-build
