...
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/kdegraphics-mobipocket-21.12.0.tar.xz
...
%prep
%setup -q -n kdegraphics-mobipocket-21.12.0
cd %{_builddir}/kdegraphics-mobipocket-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639634946
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdegraphics-mobipocket-21.12.0/COPYING %{buildroot}/usr/share/package-licenses/kdegraphics-mobipocket/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
pushd clr-build
%make_install
popd
