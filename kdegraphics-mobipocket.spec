...
Source0  : https://download.kde.org/stable/release-service/19.12.1/src/kdegraphics-mobipocket-19.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.1/src/kdegraphics-mobipocket-19.12.1.tar.xz.sig
...
%prep
%setup -q -n kdegraphics-mobipocket-19.12.1
cd %{_builddir}/kdegraphics-mobipocket-19.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578613403
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdegraphics-mobipocket-19.12.1/COPYING %{buildroot}/usr/share/package-licenses/kdegraphics-mobipocket/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
pushd clr-build
%make_install
popd
