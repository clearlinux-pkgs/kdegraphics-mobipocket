...
Source0  : https://download.kde.org/stable/release-service/20.08.2/src/kdegraphics-mobipocket-20.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.2/src/kdegraphics-mobipocket-20.08.2.tar.xz.sig
...
%prep
%setup -q -n kdegraphics-mobipocket-20.08.2
cd %{_builddir}/kdegraphics-mobipocket-20.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602640572
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdegraphics-mobipocket-20.08.2/COPYING %{buildroot}/usr/share/package-licenses/kdegraphics-mobipocket/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
pushd clr-build
%make_install
popd
